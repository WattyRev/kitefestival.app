...
describe("events/route", () => {
    ...
    describe("POST", () => {
        ...
        it("requires unique name and creates event", async () => {
            // name check
            sql.mockResolvedValueOnce({ rows: [] }) // existing name check
            ...
            const req = {
                json: jest
                    .fn()
                    .mockResolvedValue({ name: "Test", description: "d" }),
            };
            const res = await POST(req);
            const data = await res.json();
    ...
    describe("DELETE", () => {
        ...
        it("deletes all events with snapshot", async () => {
            sql.mockResolvedValueOnce({ rows: [] }) // events snapshot
