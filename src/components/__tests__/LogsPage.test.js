...
describe('logsPage', () => {
    const mockLogs = [
        { id: 1, timestamp: new Date("2024-07-01T12:00:00Z"), action: "Created event", event: "Kite Festival", eventId: 1, activity: null, activityId: null },
        { id: 2, timestamp: new Date("2024-07-02T13:00:00Z"), action: "Added activity", event: "Kite Festival", eventId: 1, activity: "Setup", activityId: 101 },
    ];
    const mockEvents = [
        { id: 1, name: "Kite Festival" },
    ]
    beforeEach(() => {
    ...
    it('allows filtering by event id', async () => {
        ...
        await userEvent.selectOptions(
            screen.getByTestId('event-filter'),
            '1'
        );
