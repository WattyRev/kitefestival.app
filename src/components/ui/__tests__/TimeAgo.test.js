...
describe("components/ui/TimeAgo", () => {
    ...
    it('renders "2 hours ago"', () => {
        render(
            <TimeAgo timestamp={new Date().getTime() - 1000 * 61 * 60 * 2} />,
        );
        expect(screen.getByText("2 hours ago")).toBeInTheDocument();
    });
    it('renders "1 day ago"', () => {
        render(
            <TimeAgo timestamp={new Date().getTime() - 1000 * 61 * 60 * 24} />,
        );
    ...
    it('renders "2 days ago"', () => {
        render(
            <TimeAgo
                timestamp={new Date().getTime() - 1000 * 61 * 60 * 24 * 2}
            />,
        );
    ...
    it('renders "1 month ago"', () => {
        render(
            <TimeAgo
                timestamp={new Date().getTime() - 1000 * 61 * 60 * 24 * 31}
            />,
        );
    ...
    it('renders "2 months ago"', () => {
        render(
            <TimeAgo
                timestamp={new Date().getTime() - 1000 * 61 * 60 * 24 * 31 * 2}
            />,
        );
    ...
    it('renders "1 year ago"', () => {
        render(
            <TimeAgo
                timestamp={new Date().getTime() - 1000 * 61 * 60 * 24 * 31 * 12}
            />,
        );
    ...
    it('renders "2 years ago"', () => {
        render(
            <TimeAgo
                timestamp={
                    new Date().getTime() - 1000 * 61 * 60 * 24 * 31 * 12 * 2
                }
            />,
        );
